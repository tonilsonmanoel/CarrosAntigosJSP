    ...
    <main class="container-geral">
        <div class="form-container">
            ...
            <div class="form">
                    ...
                    <h2 class="whitep">Informações Pessoais: </h2><br>
                    <p class="whitep">Nome: <%=u.getNome()%></p><br>
                    <p  class="whitep">E-mail: <%=u.getEmail()%></p><br>
                    <p class="whitep">Senha: *********</p>
                    
                   
                    <a href="mudarSenha.jsp" ><button class="botao">Mudar Senha</button></a>
                     <a href="index.jsp" id="cadastrar-a">Voltar</a>
